...
Open Game.html in any modern web browser (Chrome, Firefox, Edge, etc.).

Enter player names when prompted and start playing.
...
Players take turns placing their mark in an empty box.
